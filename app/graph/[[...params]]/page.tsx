...
import { GraphVisualization, GraphVisualizationRef } from "@/components/graph-visualization";
...
import { useVisualization, useNodeDetails } from "@/hooks/use-api";
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <aside className="w-80 border-r bg-white dark:bg-gray-900 p-4 overflow-y-auto lg:block hidden">
          ...
          <FilterPanel
            ...
            onRelationshipTypeChange={(types) => setSelectedRelationshipTypes(types)}
